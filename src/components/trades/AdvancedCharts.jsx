  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow">
        <h3 className="text-lg font-bold mb-4 text-slate-900 dark:text-slate-100">Resultado por Operação ($)</h3>
      ...
      <div className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow">
        <h3 className="text-lg font-bold mb-4 text-slate-900 dark:text-slate-100">Impacto no Saldo (%)</h3>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={operationsData}>
            <CartesianGrid strokeDasharray="3 3" />
            <XAxis dataKey="index" />
